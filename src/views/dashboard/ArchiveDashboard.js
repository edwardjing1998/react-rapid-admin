...
import TransactionChart from './ArchiveTransactionChart'
import CasesChart from './ArchiveCasesChart'
...
const ArchiveDashboard = () => {
  ...
  const globalMax = Math.max(
    ...progressGroupExample2.flatMap((item) => [item.value1, item.value2])
  )
      ...
      <CCard className="mb-4">
        <CCardBody>
          <CRow>
            ...
            {selectedView === 'Cases' ? <CasesChart /> : <TransactionChart />}
        </CCardBody>
      </CCard>
    </>
  )
